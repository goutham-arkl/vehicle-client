    ...
    data.map((item) => {
      ...
      const animation = gsap
        .to(classname, {
          x: x,
          y: y,
          duration: item.speed > 10 ? 10 - item.speed / 10 : 10 - item.speed,
        })
        .timeScale(0.5);
      tl.add(animation, 0);
    });
      ...
      if (result.isConfirmed) {
        axios
          ...
          .then((res) => {
            ...
            Swal.fire("Deleted!", `res.data has been deleted`, "success");
            console.log(reload);
            setReload(!reload);
          })
          .catch((err) => {
        ...
        <div className="scenario-chooser">
          ...
          <div>
            <button
              ...
              onClick={() => showAnimation(1)}
            >
              Start simulation
            </button>
            <button
              className=" btn kill"
              onClick={() => gsap.killTweensOf(".vehicles")}
            >
              Stop
            </button>
          </div>
          ...
          {data &&
            data.map((item) => (
              <div
                ...
                style={{
                  backgroundColor: `${
                    chooseColor(item.name) ? chooseColor(item.name) : "gray"
                  }`,
              ...
              {modalData && (
                <div className="values-div">
                  ...
                  <button
                    ...
                    style={{ backgroundColor: "#b33f40", border: "none" }}
                  >
                    Cancel
                  </button>
                </div>
